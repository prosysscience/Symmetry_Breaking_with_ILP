...
class GenerateExample:
	def __init__(self, directory, sat_mode, fullSBC, instance, number_of_cells, maxsizecell, seed, abk):
		if sat_mode:
			self.idAS = 0
		else:
			self.idAS = 1
...
# MAIN
"""
def main(directory, sat_mode, fullSBC, instance, number_of_cells, maxsizecell, seed, abk):
	my_generator = GenerateExample(directory, sat_mode, fullSBC, instance, number_of_cells, maxsizecell,  seed, abk)
